...
('Smartphones',     'smartphones',    'Telemóveis de última geração das melhores marcas', 'assets/images/categories/smartphones.jpg'),
('Laptops',         'laptops',        'Computadores portáteis para trabalho e entretenimento', 'assets/images/categories/laptops.jpg'),
('Smartwatches',    'smartwatches',   'Relógios inteligentes e wearables premium', 'assets/images/categories/smartwatches.jpg'),
('Auscultadores',   'auscultadores',  'Headphones e earbuds com som de alta fidelidade', 'assets/images/categories/auscultadores.jpg'),
('Tablets',         'tablets',        'Tablets para produtividade e criatividade', 'assets/images/categories/tablets.jpg'),
('Câmeras',         'cameras',        'Câmeras e equipamento fotográfico profissional', 'assets/images/categories/cameras.jpg');
...
-- Cameras (21-24)
('Sony A7RV', 'sony-a7rv', 'Mirrorless full-frame de 61MP com autofoco com IA.', 1890000, 2000000, 3, 'cameras', 'Sony', 'assets/images/products/cameras_1.jpg', 4.9, 45, 1),
('Canon EOS R5', 'canon-eos-r5', 'Câmera full-frame fantástica para fotos 45MP e vídeo 8K.', 1750000, 1850000, 4, 'cameras', 'Canon', 'assets/images/products/cameras_2.jpg', 4.8, 62, 1),
('Fujifilm X100VI', 'fujifilm-x100vi', 'A câmera compacta premium mais desejada do mercado.', 850000, 920000, 2, 'cameras', 'Fujifilm', 'assets/images/products/cameras_3.jpg', 4.9, 128, 0),
('DJI Osmo Action 4', 'dji-osmo-action-4', 'A melhor câmera de ação para baixa luminosidade.', 189000, 210000, 18, 'cameras', 'DJI', 'assets/images/products/cameras_4.jpg', 4.6, 89, 0);
